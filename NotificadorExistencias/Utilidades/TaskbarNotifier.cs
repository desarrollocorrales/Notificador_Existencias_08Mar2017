...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		protected Color normalTitleColor = Color.FromArgb(53,12,83);
		protected Color hoverTitleColor = Color.FromArgb(255,0,0);
		protected Color normalContentColor = Color.FromArgb(102,57,137);
		protected Color hoverContentColor = Color.FromArgb(0,0,0x66);
        protected Font normalTitleFont = new Font("Consolas", 30, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("Consolas", 12, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("Consolas", 18, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("Consolas", 18, FontStyle.Regular, GraphicsUnit.Pixel);
